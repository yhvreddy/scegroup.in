<?php include 'header.php'; ?>
    ...
    <section class="slider_area row m0">
        <div class="slider_inner">
            <div data-thumb="<?=base_url()?>assets/images/slider-1.jpg" data-src="<?=base_url()?>assets/images/slider-1.jpg">
            ...
            <div data-thumb="<?=base_url()?>assets/images/slider-2.jpg" data-src="<?=base_url()?>assets/images/slider-2.jpg">
                <div class="camera_caption">
                   <div class="container">
                        <h5 class=" wow fadeInUp animated">Welcome to our</h5>
                        <h3 class=" wow fadeInUp animated" data-wow-delay="0.5s">CLEAN ,MODERN, MULTIPURPOSE THEME</h3>
        ...
        <div class="container">
            ...
            <div class="row about_row">
                ...
                <div class="col-md-5 col-sm-6 about_client">
                    <img src="<?=base_url()?>assets/images/about_client.jpg" alt="">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="featured_works row" data-stellar-background-ratio="0.3">
        ...
        <div class="featured_gallery">
            <div class="col-md-3 col-sm-4 col-xs-6 gallery_iner p0">
                <img src="<?=base_url()?>assets/images/gallery/gl-1.jpg" alt="">
                <div class="gallery_hover">
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 gallery_iner p0">
                <img src="<?=base_url()?>assets/images/gallery/gl-2.jpg" alt="">
                <div class="gallery_hover">
                    <h4>Bolt Apartments</h4>
                    <a href="#">VIEW PROJECT</a>
                </div>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 gallery_iner p0">
                <img src="<?=base_url()?>assets/images/gallery/gl-3.jpg" alt="">
                <div class="gallery_hover">
                    <h4>Bolt Apartments</h4>
                    <a href="#">VIEW PROJECT</a>
                </div>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 gallery_iner p0">
                <img src="<?=base_url()?>assets/images/gallery/gl-4.jpg" alt="">
                <div class="gallery_hover">
                    <h4>Bolt Apartments</h4>
                    <a href="#">VIEW PROJECT</a>
                </div>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 gallery_iner p0">
                <img src="<?=base_url()?>assets/images/gallery/gl-5.jpg" alt="">
                <div class="gallery_hover">
                    <h4>Bolt Apartments</h4>
                    <a href="#">VIEW PROJECT</a>
                </div>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 gallery_iner p0">
                <img src="<?=base_url()?>assets/images/gallery/gl-6.jpg" alt="">
                <div class="gallery_hover">
                    <h4>Bolt Apartments</h4>
                    <a href="#">VIEW PROJECT</a>
                </div>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 gallery_iner p0">
                <img src="<?=base_url()?>assets/images/gallery/gl-7.jpg" alt="">
                <div class="gallery_hover">
                    <h4>Bolt Apartments</h4>
                    <a href="#">VIEW PROJECT</a>
                </div>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 gallery_iner p0">
                <img src="<?=base_url()?>assets/images/gallery/gl-8.jpg" alt="">
                <div class="gallery_hover">
                    <h4>Bolt Apartments</h4>
                    <a href="#">VIEW PROJECT</a>
                </div>
        ...
        <div class="container">
            ...
            <div class="row latest_blog">
                <div class="col-md-4 col-sm-6 blog_content">
                    <img src="<?=base_url()?>assets/images/blog/lb-1.jpg" alt="">
                ...
                <div class="col-md-4 col-sm-6 blog_content">
                    <img src="<?=base_url()?>assets/images/blog/lb-2.jpg" alt="">
                    <a href="#" class="blog_heading">Our Latest Project</a>
                    <h4><small>by  </small><a href="#">Prodip Ghosh</a><span>/</span><small>ON </small> October 15, 2016</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam sagittis iaculis velit in tristique. Curabitur ac urna urna. Sed sollicitudin at nisi sed accumsan... <a href="#">Read More</a></p>
                </div>
                <div class="col-md-4 col-sm-6 blog_content">
                    <img src="<?=base_url()?>assets/images/blog/lb-3.jpg" alt="">
                    <a href="#" class="blog_heading">Our Latest Project</a>
                    <h4><small>by  </small><a href="#">Prodip Ghosh</a><span>/</span><small>ON </small> October 15, 2016</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam sagittis iaculis velit in tristique. Curabitur ac urna urna. Sed sollicitudin at nisi sed accumsan... <a href="#">Read More</a></p>
                </div>
