          ...
          <div class="box box-primary">
            ...
            <?php }else{ ?>
                <form role="form" method="post" action="<?=base_url('admin/savepartnersdetails')?>" enctype="multipart/form-data">
                  ...
                  <div class="box-footer">
                    <button type="submit" class="btn btn-primary pull-right">Upload Partners</button>
                  </div>
                </form>
            <?php } ?>
          </div>
              ...
              <tbody>
                <?php $i = 1; foreach ($partners as $key => $partner) { ?>
                  <tr>
                    ...
                    <td><?=$partner->title?></td>
                    <td>
                      <a href="<?=base_url('cpanel/dashboard/banners/'.$partner->id.'/edit')?>" onclick="return confirm('Are you sure to edit banner details..?')"><i class="fa fa-edit"></i></a>&nbsp;
                      <a href="<?=base_url('cpanel/dashboard/banners/'.$partner->id.'/delete')?>" onclick="return confirm('Are you sure to delete banner details..?')"><i class="fa fa-trash-o"></i></a>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
